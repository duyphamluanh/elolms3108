...
// Elo: Duy added test en
$string['clickhere'] = 'Click here';
$string['login'] = 'Đăng nhập';
$string['loginguest'] = 'Đăng nhập với tư cách khách';

$string['guidelines'] = 'Lựa chọn hiển thị hướng dẫn';
$string['guidelines_desc'] = 'Chọn một trong các lựa chọn dưới đây. Hiển thị hoặc ẩn hướng dẫn ở trang đăng nhập.';
$string['showfooter'] = 'Lựa chọn hiển thị footer';
$string['showfooter_desc'] = 'Chọn một trong các lựa chọn dưới đây. Hiển thị hoặc ẩn footer ở trang đăng nhập.';
...
$string['address:footer'] = ' 97 Võ Văn Tần, Phường 6, Quận 3, Thành phố Hồ Chí Minh';
$string['phonenumber:footer'] = '(+84)28.39300073; 18006119 (Nhấn phím 2)';

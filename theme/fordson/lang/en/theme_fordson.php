...
// Elo: Settings show/hide login guide
$string['guidelines'] = 'Guidelines Chooser';
$string['guidelines_desc'] = 'Choose from the following options. Show/Hide guildelines in login.';
$string['showfooter'] = 'Show/hide footer Chooser';
$string['showfooter_desc'] = 'Choose from the following options. Show/Hide footer in login.';
$string['show'] = 'Show';
$string['hide'] = 'Hide';
...
$string['office:footer'] = 'Office';
$string['contact:footer'] = 'Contact';
$string['connect:footer'] = 'Connect';
$string['address:footer'] = ' 97 Vo Van Tan Street, Ward 6, District 3, Ho Chi Minh City';
$string['phonenumber:footer'] = '(+84)28.39300073; 18006119 (Ext 2)';

$string['navigation:footer'] = 'Navigation';
$string['homepage:footer'] = 'My Home';
$string['calendar:footer'] = 'Calendar';
$string['mycourses:footer'] = 'My courses';
$string['elearningcenter:footer'] = 'E-learning Center';
$string['home:footer'] = 'Home Page';
$string['introduceprogram:footer'] = 'Introduction the program';
$string['objects:footer'] = 'Catalog';
$string['studentknowledge:footer'] = 'Students to know';
$string['news:footer'] = 'News / ';
$string['events:footer'] = 'Events';
$string['connectwithus:footer'] = 'Conntect with us';
$string['copyright:footer'] = '© 2018 Ho Chi Minh City Open University. All rights reserved.';

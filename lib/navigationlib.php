...
class global_navigation extends navigation_node {
    ...
    public function initialise() {
        ...
        if ($enrolledinanycourse) {
            ...
            // Elo: Duy added values into rootnodes for courses collapse
            if ($this->rootnodes['mycourses']->key == 'mycourses') {
                //nhien elo show collapse my courses
                $this->rootnodes['mycourses']->showhtmlcollapse = true;    
            }
        } else {
            $this->rootnodes['courses']->isexpandable = true;
        }
    ...
    protected function load_courses_enrolled() {
        ...
        foreach ($courses as $course) {
            ...
            if ($node) {
                ...
                // Elo: Duy Set always true for flatnavigation courses false -> true
                $node->showinflatnavigation = true;
            }
        }
